...
var ChannelDefaultCooldownSeconds = env.Int("CHANNEL_DEFAULT_COOLDOWN_SECONDS", 60)
var ChannelMaxCooldownSeconds = env.Int("CHANNEL_MAX_COOLDOWN_SECONDS", 600)
